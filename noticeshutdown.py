...
# see how many events have occurred today.
...
html_1a = "The forecast for Canberra is:<br>Tonight : " + getTonightsColour() + forecastTonight + "</span><br>Tomorrow : " + getTomorrowsColour() + forecastTomorrow + "</span><br><br>"
